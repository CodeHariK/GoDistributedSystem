...
import (
	...
	context "context"
	errors "errors"
	api "github.com/codeharik/k7/example/api"
	http "net/http"
	strings "strings"
)
...
type GreetServiceClient interface {
	Greet(context.Context, *connect.Request[api.GreetRequest]) (*connect.Response[api.GreetResponse], error)
}
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := api.File_greet_proto.Services().ByName("GreetService").Methods()
	return &greetServiceClient{
		greet: connect.NewClient[api.GreetRequest, api.GreetResponse](
			httpClient,
...
type greetServiceClient struct {
	greet *connect.Client[api.GreetRequest, api.GreetResponse]
}

// Greet calls greet.GreetService.Greet.
func (c *greetServiceClient) Greet(ctx context.Context, req *connect.Request[api.GreetRequest]) (*connect.Response[api.GreetResponse], error) {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[api.GreetRequest]) (*connect.Response[api.GreetResponse], error) {
